    ...
    button.addEventListener('click', function () {
        ...
        if (selectedRange === 'today') {
            ...
            updateDashboard(
                ...
                formatCurrency(150000), '3.2k orders', formatCurrency(150500), formatCurrency(-500), formatCurrency(150000), formatCurrency(140000), formatCurrency(160000) // Foreshadowing values
            );
        } else if (selectedRange === 'this-month') {
            updateDashboard(
                Array.from({ length: 30 }, () => Math.floor(Math.random() * 35000)),
                formatCurrency(320000), '9k orders', formatCurrency(321000), formatCurrency(-700), formatCurrency(320000), formatCurrency(310000), formatCurrency(330000) // Foreshadowing values
            );
            ...
            updateDashboard(
                ...
                formatCurrency(290000), '8.4k orders', formatCurrency(290000), formatCurrency(-10000), formatCurrency(290000), formatCurrency(280000), formatCurrency(300000) // Foreshadowing values
            );
            ...
            updateDashboard(
                ...
                formatCurrency(1500000), '85k orders', formatCurrency(1500000), formatCurrency(-10000), formatCurrency(1500000), formatCurrency(1400000), formatCurrency(1600000) // Foreshadowing values
            );
        }
    });
});
